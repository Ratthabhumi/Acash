"""Phase 8.5 Step R1 Registration & Governance Normalization Script: HYP_TSMOM_EURUSD_HTF_002.

Strictly enforces:
1. Normalizes candidate hypothesis identity from HYP_TSMOM_EURUSD_HTF_001 to canonical
   sequential identifier HYP_TSMOM_EURUSD_HTF_002 (representing HYP_002).
2. Submits candidate proposal to ResearchReInceptionGate for formal evaluation.
3. Generates a fresh InceptionAuthorizationToken bound to HYP_TSMOM_EURUSD_HTF_002.
4. Seals canonical HypothesisSpecification to docs/phase8.5/hypotheses/HYP_TSMOM_EURUSD_HTF_002.json.
5. Computes authoritative canonical SHA-256 digests.
6. Emits canonical R1 manifest for HYP_TSMOM_EURUSD_HTF_002.
7. Preserves complete historical audit trail and lineage mapping.
8. Strictly maintains fail-closed boundaries: zero market data access, $0.00 capital, R2 locked.
"""
...
def register_step_r1_htf_002() -> None:
    print("================================================================================")
    print("ACASH PHASE 8.5 STEP R1: HYPOTHESIS IDENTITY NORMALIZATION (HYP_002)")
    print("Canonical Identity: HYP_TSMOM_EURUSD_HTF_002")
    print("Superseded Administrative ID: HYP_TSMOM_EURUSD_HTF_001")
    print("================================================================================")

    registered_at_utc = "2026-09-07T00:00:00Z"

    # 1. Construct Proposal for HYP_TSMOM_EURUSD_HTF_002
    proposal = ResearchInceptionProposal(
        candidate_hypothesis_id="HYP_TSMOM_EURUSD_HTF_002",
    ...
    print("\n[Step 1] Submitting candidate proposal HYP_TSMOM_EURUSD_HTF_002 to ResearchReInceptionGate...")
    ...
    # 2. Build Canonical HypothesisSpecification
    parameter_config = {
        "bar_frequency": "H4",
        ...
        "administrative_metadata": {
            ...
            "superseded_administrative_id": "HYP_TSMOM_EURUSD_HTF_001",
            "normalization_rationale": "Enforce explicit sequential ordinal numbering (HYP_002) in canonical research lineage.",
        },
        "cost_model_proposed": {
    ...
    pretty_dict = hyp_spec.model_dump(mode="json")
    hyp_file.write_text(json.dumps(pretty_dict, indent=2), encoding="utf-8")
    print(f" -> Persisted Canonical Sealed Hypothesis to: {hyp_file}")

    # Mirror in data/manifests/research/hypotheses/
    ...
    print("\n================================================================================")
    print("HYP_002 CANONICAL NORMALIZATION COMPLETED & SEALED!")
