...
def generate_audit_document(
    ...
    lines.extend([
        ...
        "3. **Historical No-Auction Fallback Policy (OPEN_REGIME_DEPENDENT):** NYSE Arca Rule 1.1 Official Closing Price methodology for ETPs underwent a structural regime change on 2018-06-04. Fallback is regime-dependent and not yet implementable.",
        "",
        "---",
        "",
        ...
        "- **`PREVIOUS_CLOSE_FALLBACK_POLICY`**: `OPEN_REGIME_DEPENDENT` (Regime-dependent fallback: pre-2018-06-04 consolidated last sale; post-2018-06-04 AOCP; technical outage rules separate. Not yet implementable.)",
