...
| 🔬 **Phase 8.5: Alpha Research & Evidence** | Research lineage, hypothesis pre-registration, search census, terminal falsification | [`docs/phase8.5/phase8_5_hyp_tsmom_eurusd_001_terminal_falsification_dossier.md`](./phase8.5/phase8_5_hyp_tsmom_eurusd_001_terminal_falsification_dossier.md) • [`docs/phase8.5/phase8_5_r3_search_trial_census_audit.md`](./phase8.5/phase8_5_r3_search_trial_census_audit.md) • [`docs/phase8.5/phase8_5_r2_data_preparation_audit.md`](./phase8.5/phase8_5_r2_data_preparation_audit.md) |
...
## 🏛️ Current Governance & Runtime State (2026-09-06)
- **Phase 8.5 Track B (Research Lineage):** CLOSED / TERMINALLY FALSIFIED (`HYP_TSMOM_EURUSD_001` rejected; R4–R7 early terminated; OOS pristine).
...
- **Strategy Admission:** Strictly **`NOT QUALIFIED / TERMINALLY FALSIFIED`** (`STRAT-MOM-MULTI-HORIZON-V1`).
