...
| ⚡ **Phase 7: Live Execution & Risk** | Pre-Live Risk Admission, Live Authorization, Broker Semantic Mapping (BMAP), Kill Switch, Reconciliation | [`docs/phase7/CONTEXT_MAP.md`](./phase7/CONTEXT_MAP.md) • [`docs/phase7/alpaca_bmap.md`](./phase7/alpaca_bmap.md) • [`docs/phase7/r1_paper_run_runbook.md`](./phase7/r1_paper_run_runbook.md) • [`docs/phase7/execution_state_machine.md`](./phase7/execution_state_machine.md) |
