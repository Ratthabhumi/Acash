...
export const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-24 bg-slate-900/50 backdrop-blur-xs p-4 animate-in fade-in duration-100">
      <div 
        className="w-full max-w-lg bg-white rounded-lg shadow-xl border border-slate-200 overflow-hidden"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Search Header */}
        <div className="flex items-center px-3.5 border-b border-slate-200 bg-slate-50/50">
          ...
          <input
            ...
            className="w-full px-3 py-3 text-xs text-slate-800 bg-transparent placeholder-slate-400 focus:outline-none font-sans"
          />
          <button
            onClick={onClose}
            ...
            filtered.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {isSelected && (
                    <div className="flex items-center space-x-1 text-[11px] text-slate-400 font-mono-code">
                      <span>Select</span>
        ...
        {/* Footer */}
        <div className="px-3.5 py-2 bg-slate-50 border-t border-slate-200 flex items-center justify-between text-[11px] text-slate-500 font-mono-code">
