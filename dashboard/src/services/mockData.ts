  ...
  for (let i = 1; i <= 127; i++) {
    ...
    trades.push({
      ...
      evidenceChain: {
        ...
        riskDecisionId: `RISK-APPR-${String(i).padStart(4, '0')}`,
        riskVerdict: 'APPROVED_BOUNDED',
...
const mockLineageNodes: LineageNode[] = [
  {
    ...
    sourceModule: 'acash.data.parquet_provider',
  ...
  },
  {
    ...
    sourceModule: 'acash.data.schema',
  ...
  },
  {
    ...
    sourceModule: 'acash.data.features.engine',
  ...
  },
  {
    ...
    sourceModule: 'acash.research.evaluation',
  ...
  },
  {
    ...
    authorityRule: 'SOVEREIGN_RISK_GATE_V2',
    sourceModule: 'acash.risk.kill_switch',
    timestamp: '2026-05-15T00:16:00Z',
    inputLineage: ['stage-4-signal'],
    outputLineage: ['stage-6-order-intent'],
    mockEvidencePayload: {
      killSwitchState: 'NOMINAL_ENGAGED',
  ...
  },
  {
    ...
    authorityRule: 'SINGLE_AUTHORITY_INTENT',
    sourceModule: 'acash.paper.runner',
  ...
  },
  {
    ...
    authorityRule: 'FAIL_CLOSED_FRICTION_MODEL',
    sourceModule: 'acash.paper.runner',
  ...
  },
  {
    ...
    authorityRule: 'CANONICAL_LOT_ACCOUNTING',
    sourceModule: 'acash.portfolio.planner',
  ...
  },
  {
    ...
    stageNumber: 9,
    stageName: 'Portfolio',
    shortTitle: 'Equity Ledger',
    description: 'End-of-bar equity, mark-to-market valuations, and cash allocation accounting.',
    artifactName: 'portfolio_equity_curve.arrow',
    hashOrDigest: 'sha256:6631adbf90aa...',
    authorityRule: 'CONSERVATION_OF_CAPITAL',
    sourceModule: 'acash.portfolio.evaluation',
    timestamp: '2026-05-15T00:20:00Z',
    inputLineage: ['stage-8-position'],
    outputLineage: ['stage-10-metrics'],
    mockEvidencePayload: {
      startingCashUsd: 100000,
      endingCashUsd: 118420,
      unrealizedPnlAccounting: 'STRICT_MTM',
    },
  },
  {
    id: 'stage-10-metrics',
    ...
    authorityRule: 'ANNUALIZED_H4_BAR_STANDARD',
    sourceModule: 'acash.paper.analytics',
  ...
  },
  {
    ...
    authorityRule: 'GOVERNANCE_STATISTICAL_GATE_V5',
    sourceModule: 'acash.validation.gate',
...
const mockValidationCriteria: ValidationCriterion[] = [
  ...
  {
    id: 'VAL-CRIT-04',
    name: 'Blind Out-of-Sample Isolation',
    ruleSpecification: 'Validation partition (3,751..4,996) and OOS partition (5,009..6,230) must remain UNEXPOSED.',
    observedMetric: 'OOS partitions unexposed and untouched in repository',
    status: 'NOT_EVALUATED',
    category: 'OUT_OF_SAMPLE',
    notes: 'OOS evaluation is prohibited prior to human research committee ratification.',
  },
  {
    id: 'VAL-CRIT-05',
...
const mockTimelineEvents: TimelineEvent[] = [
  ...
  },
  {
    ...
    title: 'Portfolio Full De-Risk Transition',
    summary: 'Rebalance planner executed planned derisking to 85% cash buffer prior to volatile macro release.',
    sourceModule: 'acash.portfolio.planner',
    payload: {
      targetCashRatio: 0.85,
      positionsClosed: 2,
  ...
  },
  {
    ...
    title: '90-Day Simulation Window Sealed',
    summary: 'Simulation concluded after 90 days, 127 trades, and 3,739 observations. Manifest sealed with SHA-256.',
    sourceModule: 'acash.paper.manifest',
