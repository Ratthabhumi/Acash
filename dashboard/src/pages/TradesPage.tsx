    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg border border-enterprise-border dark:border-slate-800 p-4 shadow-xs space-y-3 transition-colors">
        ...
        <div className="flex flex-wrap items-center gap-4 pt-2 border-t border-slate-100 dark:border-slate-800 text-xs font-mono-code text-slate-600 dark:text-slate-400">
          ...
          <div>·</div>
          <div>
            Cumulative PnL: <span className={`font-semibold ${summaryStats.totalPnlBps >= 0 ? 'text-emerald-700 dark:text-emerald-400' : 'text-rose-700 dark:text-rose-400'}`}>
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {paginatedTrades.map((t) => (
                ...
                >
                  ...
                  <td
                    className={`py-2.5 text-right font-medium ${
                      t.pnlUsd >= 0 ? 'text-emerald-700 dark:text-emerald-400' : 'text-rose-700 dark:text-rose-400'
                    }`}
                  >
                  ...
                  <td
                    className={`py-2.5 text-right font-medium ${
                      t.rMultiple >= 0 ? 'text-emerald-700 dark:text-emerald-400' : 'text-rose-700 dark:text-rose-400'
                    }`}
                  >
