...
class HealthEventKind(str, Enum):
    ...
    FEED_RECOVERY_ATTEMPTED = "FEED_RECOVERY_ATTEMPTED"
    FEED_RECOVERY_SUCCEEDED = "FEED_RECOVERY_SUCCEEDED"
    FEED_RECOVERY_FAILED = "FEED_RECOVERY_FAILED"
    FEED_RECOVERY_BUDGET_EXHAUSTED = "FEED_RECOVERY_BUDGET_EXHAUSTED"
    FEED_RECOVERY_ABORTED = "FEED_RECOVERY_ABORTED"
...
_KIND_TO_EVENT_TYPE: Dict[HealthEventKind, JournalEventType] = {
    ...
    HealthEventKind.FEED_RECOVERING: JournalEventType.FEED_RECOVERING,
    HealthEventKind.FEED_RECOVERY_ATTEMPTED: JournalEventType.FEED_RECOVERY_ATTEMPTED,
    HealthEventKind.FEED_RECOVERY_SUCCEEDED: JournalEventType.FEED_RECOVERY_SUCCEEDED,
    HealthEventKind.FEED_RECOVERY_FAILED: JournalEventType.FEED_RECOVERY_FAILED,
    HealthEventKind.FEED_RECOVERY_BUDGET_EXHAUSTED: JournalEventType.FEED_RECOVERY_BUDGET_EXHAUSTED,
    HealthEventKind.FEED_RECOVERY_ABORTED: JournalEventType.FEED_RECOVERY_ABORTED,
    HealthEventKind.CANDIDATE_ADDED: JournalEventType.CANDIDATE_ADDED,
    HealthEventKind.CANDIDATE_REJECTED: JournalEventType.CANDIDATE_REJECTED,
